    ...
    var demo = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '{{ route('backend.ajax.customers') }}',
                        method: 'GET',
                        ...
                        map: function(raw) {
                            // sample data mapping
                            var dataSet = raw;
                            if (typeof raw.customers !== 'undefined') {
            ...
            columns: [
                {
                    ...
                    template: function(row) {
                        console.log(row.id);
                        return '\
                        <a href="/admin/customer/edit/'+ row.id +'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">\
