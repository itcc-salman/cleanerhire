                    ...
                    @else
                        ...
                        if(response.services.residential){
                            ...
                            $.each(response.services.residential, function(index, el) {
                                ...
                                htmlstring = htmlstring + '<div class="form-group kt-mb-5 kt-mt-5 d-none" id="service_'+ el.id +'"><label>Rate per hour</label><input type="text" name="rate_per_hour_'+ el.id +'" class="form-control" value="'+ el.rate_per_hour +'"><label>Do you have relevant equipments?</label><div class="kt-radio-inline"><label class="kt-radio kt-radio--tick kt-radio--brand"><input type="radio" value="1" name="has_equipment_residential_'+el.id+'"> Yes <span></span></label><label class="kt-radio kt-radio--tick kt-radio--brand"><input type="radio" value="0" name="has_equipment_residential_'+el.id+'"> No <span></span></label></div></div></div></div>';
                            });
                        }
                        ...
                        if(response.services.commercial){
                            ...
                            $.each(response.services.commercial, function(index, el) {
                                ...
                                htmlstring = htmlstring + '<div class="form-group kt-mb-5 kt-mt-5 d-none" id="service_commercial_'+ el.id +'"><label>Rate per hour</label><input type="text" name="rate_per_hour_commercial_'+ el.id +'" class="form-control" value="'+ el.rate_per_hour +'"><label>Do you have relevant equipments?</label><div class="kt-radio-inline"><label class="kt-radio kt-radio--tick kt-radio--brand"><input type="radio" value="1" name="has_equipment_commercial_'+el.id+'"> Yes <span></span></label><label class="kt-radio kt-radio--tick kt-radio--brand"><input type="radio" value="0" name="has_equipment_commercial_'+el.id+'"> No <span></span></label></div></div></div></div>';
                            });
                        }
                    @endif
