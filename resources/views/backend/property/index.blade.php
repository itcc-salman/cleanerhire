        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                ...
                <div class="dropdown dropdown-inline">
                    <a href="{{ route('backend.properties.create') }}" class="btn btn-brand btn-icon-sm">
    ...
    var demo = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '{{ route('backend.ajax.properties') }}',
                        method: 'GET',
                        ...
                        map: function(raw) {
                            // sample data mapping
                            var dataSet = raw;
                            if (typeof raw.properties !== 'undefined') {
                                dataSet = raw.properties;
                            }
                            return dataSet;
                        },
                    },
            ...
            columns: [
                {
                    ...
                    template: function(row) {
                        return '\
                        <a href="{{ route('backend.properties.update') }}/'+row.id+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">\
    ...
    $(document).on('click', '.deleteme', function (e) {
        ...
        swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{ route('backend.ajax.properties.delete') }}',
                    cache: false,
                    dataType: "JSON",
                    data: {
