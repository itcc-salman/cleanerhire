                                        ...
                                        <div style="width:100% !important;">
                                            ...
                                            <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 10px; padding-left: 10px;">
                                                ...
                                                <div align="left" class="img-container left autowidth" style="padding-right: 0px;padding-left: 0px;">
                                                    ...
                                                    <img alt="Image" border="0" class="left autowidth" src="http://cleanahire.dev.com/front/images/logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 249px; display: block;" title="Image" width="249"/>
                                                    <div style="font-size:1px;line-height:15px">
                                                    </div>
                                            ...
                                            <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                    ...
                                                    <div style="font-size: 12px; line-height: 1.5; color: #71777D; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
                                                        <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                            <span style="color: #000000; font-size: 14px;">
                                                                <strong>
                                                                    Hi {{$cleaner->first_name}} {{$cleaner->last_name}},
                                                                </strong>
                                                            </span>
                                                            <br/>
                                                            A New Booking is available and details are as follow :
                                                        </p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                ...
                                                <div style="color:#71777D;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:1.5;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                    <div style="font-size: 12px; line-height: 1.5; color: #71777D; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
                                                        ...
                                                        <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                            {{$booking->rooms ?? 0 }} Rooms - {{$booking->bathrooms ?? 0 }} Bathrooms
                                                        </p>
                                                        <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                            <strong>
                                                                <span style="color: #000000; font-size: 14px;">
                                        ...
                                        <div style="width:100% !important;">
                                            ...
                                            <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                ...
                                                <div align="left" class="button-container" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://cleanahire.dev.com/mailable1" style="height:28.5pt; width:117.75pt; v-text-anchor:middle;" arcsize="11%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:16px"><![endif]-->
                                                    <a href="{{ route('front.confirm_booking_cleaner', $booking_email->token) }}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #3AAEE0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: auto; width: auto; border-top: 1px solid #3AAEE0; border-right: 1px solid #3AAEE0; border-bottom: 1px solid #3AAEE0; border-left: 1px solid #3AAEE0; padding-top: 5px; padding-bottom: 5px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank">
                                                        <span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;">
                                                            <span style="font-size: 16px; line-height: 1.8; word-break: break-word; mso-line-height-alt: 29px;">
                                                                Accept Job
                                                            </span>
                                                        </span>
                                                    </a>
                                                    ...
                                                    <div style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14px;">
                                                        <p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;">
                                                            ...
                                                            <span style="font-size: 12px;">
                                                                ...
                                                                <a href="example.com" style="text-decoration: underline; color: #71777D;" target="_blank">
                                                                    example.com
                                                                </a>
                                                            </span>
                                                            <br/>
